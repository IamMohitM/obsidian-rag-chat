...
# TODO: It's best for changes to be processed in batches
# TODO: If same file goes through different operations, then the operations handling should be better.
# for example if file is updated, there shouldn't be multiple entries for the update. just one update
class FileChangeTracker:
    def __init__(self):
        self.changes = deque()
        self.file_status = {}

    def add_change(self, event_type, file_path, new_path=None):
